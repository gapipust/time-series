...
Below are presented the characteristics of fitted models.
...
```{r echo=FALSE, fig.cap="Plot of different forecast methods", fig.subcap=c("Plot of all data", "Plot of data from cutoff date"), message=FALSE, warning=FALSE, out.height='50%', out.width='50%'}
...
Now, we are aggregating our data to weekly time series. The result is presented in Figure 13.
...
Next, we proceed to compute the sample ACF and PACF for further analysis (Figure 14).

```{r echo=FALSE, fig.align='center', fig.cap="ACF and PACF", out.height='75%', out.width='75%'}
invisible(acf2(ts_website_weekly,max.lag= 80))
```

Here the seasonality seems yearly (period of 52 weeks). Figure 15 shows seasonally (with period of 52 weeks) and regularly differenced data, $\Delta_{52}\Delta \text{Weekly Page Loads train}$ seems more stationary.
...
```{r echo=FALSE, fig.cap="Plot of forecast with expanding windows method", fig.subcap=c("Plot of all data", "Plot of data from cutoff date"), message=FALSE, warning=FALSE, out.height='50%', out.width='50%'}
